...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","BSJ_ARD","PASSWD"}, \
				{0,-1,"","BSJ_LIN","PASSWD"},  {0,-1,"","BSJ_SMP","PASSWD"}, \
				{0,-1,"","BSJ_BTM","PASSWD"},  {0,-1,"","BSJ_QT","PASSWD"}, \
				{0,-1,"","BSJ_PYT","PASSWD"},  {0,-1,"","BSJ_DB","PASSWD"}, \
				{0,-1,"","BSJ_JET","PASSWD"},  {0,-1,"","9","PASSWD"}, \
